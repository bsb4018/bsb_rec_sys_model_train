...
class DataIngestion:
    ...
    def split_ingested_interaction_features_data(self):
        try:
            ...
            sample_weight_train = np.log2(interactions_train['rating'] + 1) #save this
            sample_weight_valid = np.log2(interactions_valid['rating'] + 1) #save this
            
            interactions_train = interactions_train[['user_id', 'course_id']] #save this
            interactions_valid = interactions_valid[['user_id', 'course_id']] #save this
