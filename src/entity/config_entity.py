...
ModelTrainerConfig = namedtuple("ModelTrainerConfig", ["model_trainer_dir", \
                                                       "trained_interactions_model_file_path", \
                                                     ...
                                                     "best_interactions_model_file",\
                                                        "best_interactions_model_report_file",\
                                                            "best_interactions_model_matrix_shape_file",\
                                                              "best_users_id_map_file",\
                                                              "best_users_feature_map_file",\
                                                                "saved_production_interactions_model_file",\
                                                                    "saved_production_interactions_model_report_file",\
                                                                        ...
                                                                        "saved_model_users_id_map_file_path",\
                                                                        "saved_model_users_feature_map_file_path"
                                                                        ])
